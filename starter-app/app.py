...
@cli.command(help='Search task names and descriptions. Example: python app.py search "关键词"')
...
def search(keyword: str) -> None:
    ...
    tasks.sort(key=lambda task: {"high": 0, "medium": 1, "low": 2}.get(task.get("priority"), 3))
